        ...
        <div className={classes.register}>
            <main className={classes.formRegister}>
                <form onSubmit={submit}>
                    ...
                    <input type="text" className="form-control" id="floatingInput" placeholder="Last Name" required style={{
                        marginBottom: '3px',
                        borderBottomRightRadius: '0',
                        borderBottomLeftRadius: '0',
                    }} onChange={e => setLastName(e.target.value)} />

                    <input type="text" className="form-control" id="floatingInput" placeholder="Username" required style={{
                        marginBottom: '3px',
                        borderBottomRightRadius: '0',
                        borderBottomLeftRadius: '0',
                    ...
                    <input type="email" className="form-control" id="floatingInput" placeholder="Email" required style={{
                        marginBottom: '3px',
                        borderBottomRightRadius: '0',
                        borderBottomLeftRadius: '0',
